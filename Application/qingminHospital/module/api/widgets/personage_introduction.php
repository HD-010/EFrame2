...
$testdata =[
    ...
    'personage' => [
        [
            ...
            'introduce' => '主任药师，执业药师，药学部主任。毕业于安徽省中医学院药学专业，在职研究生学历。从事医院药学工作多年，擅长临床药学、药学服务和药事管理工作。发表学术论文多篇。...',
        ],
        [
            'name' => '江5桥',  
            'href' => '',
            'face' => '/uploads/image/20130107/20130107110136853685.jpg',  
            'introduce' => '副主任医师，康复科主任兼二十八病区主任。毕业于安徽医科大学临床医学专业，从事外科、骨科、康复科等临床工作多年。曾在安徽医科大学附属医院、中山医科大学附属医院、深圳市人民医院等进修深造，擅长颈肩腰腿疾病...',
        ],
    ],
        
];

$personageintroduction = $data ? $data : [];
...
$ref = App::params('@webServer');
?>


<div class="zhuangjie">
		<div class="sbar">
			<span><?=T::arrayValue('typename',$personageintroduction) ?></span><em>&nbsp;</em><a href="<?=$ref.T::arrayValue('typehref',$personageintroduction) ?>">更多>></a>
		</div>
		<div class="h226">
			<div>
				<ul id="foo3">
					...
					<li>
						<div class="jiaoshou">
							<a href='<?=$url.T::arrayValue('id', $list) ?>'><img
								src="<?=$ref.T::arrayValue('face', $list) ?>" width="88"
								height="115" /></a>
							<div class="jiaoshoujieshao">
								<span><?=T::arrayValue('name', $list) ?></span><br />
								<?=T::arrayValue('introduce', $list) ?>
							</div>
						</div>
						<!-- 预约 -->
						<div class="woyaoyuyue2">
							<a target="_blank" href="QQ:<?=T::arrayValue('qq', $list) ?>"><img
