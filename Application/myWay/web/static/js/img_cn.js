...
! function(t) {
	...
	function n(t) {
		var i = 0,
			e = 0;
		do {
			isNaN(t.offsetTop) || (i += t.offsetTop), isNaN(t.offsetLeft) || (e += t.offsetLeft)
	...
	function r(t, i) {
		this.el = t, this.options = s(this.defaults, i), this._init()
	}
	...
	r.prototype = {
		...
		_init: function() {
			...
			imagesLoaded(this.el, function() {
				var e = new Masonry(i.el, {
					itemSelector: "li",
					transitionDuration: 0
				});
				t.metgrid = e, Modernizr.cssanimations && (i.items.forEach(function(t, e) {
					o(t) && (i._checkTotalRendered(), classie.add(t, "shown"))
		...
		_scrollPage: function() {
			var t = this;
			this.items.forEach(function(n, s) {
				classie.has(n, "shown") || classie.has(n, "animate") || !o(n, t.options.viewportFactor) || setTimeout(function() {
					var o = e() + i() / 2;
					if(t.el.style.WebkitPerspectiveOrigin = "50% " + o + "px", t.el.style.MozPerspectiveOrigin = "50% " + o + "px", t.el.style.perspectiveOrigin = "50% " + o + "px", t._checkTotalRendered(), t.options.minDuration && t.options.maxDuration) {
						var s = Math.random() * (t.options.maxDuration - t.options.minDuration) + t.options.minDuration + "s";
						n.style.WebkitAnimationDuration = s, n.style.MozAnimationDuration = s, n.style.animationDuration = s
					}
...
METUI_FUN['img_list_page_met_m1156_1'] = METUI['img_list_page_met_m1156_1_x'] = {
	name: 'img_list_page_met_m1156_1',
	init: function() {
		if($('.swiper-header').length == 0) {
			METUI['img_list_page_met_m1156_1_x'].slide(1);
		}
	},
	resize: function(res) {

		if(!res) $(window).resize(function() {
			METUI['img_list_page_met_m1156_1_x'].resize(true);
		});
	},
	slide: function(str) {
		switch(str) {
			case 1:
				if(!METUI['slide']) {
					METUI['img_list_page_met_m1156_1']
						.css('background-image', 'url(' + METUI['img_list_page_met_m1156_1'].attr('data-background') + ')')
						.removeAttr('data-background')
				}
				METUI['img_list_page_met_m1156_1'].find('.img-li p').click(function() {
...
var x = new metui(METUI_FUN['img_list_page_met_m1156_1']);