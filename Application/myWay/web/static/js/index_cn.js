...
METUI_FUN['banner_list_met_m1156_1'] = METUI['banner_list_met_m1156_1_x'] = {
	...
	resize: function(res) {
		...
		if(!res) $(window).resize(function() {
			METUI['banner_list_met_m1156_1_x'].resize(true);
		});
	},
	slide: function(str) {
		switch(str) {
			case 1:
				...
				break;
			case 2:
				if(METUI['banner_list_met_m1156_1'].find('.banner-bin').length > 1) METUI['banner_list_met_m1156_1_index'].init();
				METUI['banner_list_met_m1156_1'].addClass('active');
				break;
			case 3:
				if(METUI['banner_list_met_m1156_1'].find('.banner-bin').length > 1) METUI['banner_list_met_m1156_1_index'].destroy(false);
...
METUI_FUN['show_list_met_m1156_1'] = METUI['show_list_met_m1156_1_x'] = {
	...
	resize: function(res) {
		...
		if(!res) $(window).resize(function() {
			METUI['show_list_met_m1156_1_x'].resize(true);
		});
	},
	slide: function(str) {
		switch(str) {
...
METUI_FUN['product_list_met_m1156_1'] = METUI['product_list_met_m1156_1_x'] = {
	...
	resize: function(res) {
		...
		if(!res) $(window).resize(function() {
			METUI['product_list_met_m1156_1_x'].resize(true);
		});
	},
	slide: function(str) {
		switch(str) {
...
METUI_FUN['video_list_met_m1156_1'] = METUI['video_list_met_m1156_1_x'] = {
	...
	resize: function(res) {
		...
		if(!res) $(window).resize(function() {
			METUI['video_list_met_m1156_1_x'].resize(true);
		});
	},
	slide: function(str) {
		switch(str) {
...
METUI_FUN['case_list_met_m1156_1'] = METUI['case_list_met_m1156_1_x'] = {
	...
	resize: function(res) {
		...
		if(!res) $(window).resize(function() {
			METUI['case_list_met_m1156_1_x'].resize(true);
		});
	},
	slide: function(str) {
		switch(str) {
...
METUI_FUN['news_list_met_m1156_1'] = METUI['news_list_met_m1156_1_x'] = {
	...
	resize: function(res) {
		...
		if(!res) $(window).resize(function() {
			METUI['news_list_met_m1156_1_x'].resize(true);
		});
	},
	slide: function(str) {
		switch(str) {
			case 1:
				...
				if(METUI['news_list_met_m1156_1'].find('.info-list').attr('data-id') != '') {
					...
					if(METUI['news_list_met_m1156_1'].find('.info-list').length == 1) {
						...
						METUI['news_list_met_m1156_1_info'] = [];
...
METUI_FUN['contact_list_met_m1156_1'] = METUI['contact_list_met_m1156_1_x'] = {
	...
	resize: function(res) {
		...
		if(!res) $(window).resize(function() {
			METUI['contact_list_met_m1156_1_x'].resize(true);
		});
	},
	slide: function(str) {
		switch(str) {
