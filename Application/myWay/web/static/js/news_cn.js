...
METUI_FUN['news_list_page_met_m1156_1'] = METUI['news_list_page_met_m1156_1_x'] = {
	name: 'news_list_page_met_m1156_1',
	init: function() {
		if($('.swiper-header').length == 0) {
			METUI['news_list_page_met_m1156_1_x'].slide(1);
		}
	},
	resize: function(res) {

		if(!res) $(window).resize(function() {
			METUI['news_list_page_met_m1156_1_x'].resize(true);
		});
	},
	slide: function(str) {
		switch(str) {
			case 1:
				if(!METUI['slide']) {
					METUI['news_list_page_met_m1156_1']
						.css('background-image', 'url(' + METUI['news_list_page_met_m1156_1'].attr('data-background') + ')')
						.removeAttr('data-background')
				}
...
var x = new metui(METUI_FUN['news_list_page_met_m1156_1']);